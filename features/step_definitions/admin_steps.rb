...
When /^I have activating user in with email "(.*?)"$/ do |emailid|
  visit admin_index_path
  page.find('[@id=useractive_user.deactive@gmail.com]').click
end\
...
When /^I have activating admin in with email "(.*?)"$/ do |emailid|
  visit admin_index_path
  page.find('[@id=adminactive_admin.deactive@gmail.com]').click
end\
...
When /^I have activating vendor in with email "(.*?)"$/ do |emailid|
  visit admin_index_path
  page.find('[@id=vendoractive_vendor.deactive@gmail.com]').click
end\
